...
public class RpcServerPlugin : Plugin
{
    ...
    protected override void OnSystemLoaded(NeoSystem system)
    {
        ...
        {
            Logger?.Warning("RcpServer: CORS is misconfigured!");
            Logger?.Warning("You have {EnableCors} and Basic Authentication enabled but {AllowOrigins} is empty in config.json for RcpServer. " +
        ...
        Logger?.Information("RpcServer started for network {Network}", s.Network);
