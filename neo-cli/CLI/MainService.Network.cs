...
namespace Neo.CLI
{
    partial class MainService
    {
        ...
        {
            OnBroadcastCommand(MessageCommand.Block, NativeContract.Ledger.GetBlock(Snapshot, hash));
        }
        ...
        {
            OnBroadcastCommand(MessageCommand.Block, NativeContract.Ledger.GetBlock(Snapshot, height));
        }
        ...
        private void OnRelayCommand(JObject jsonObjectToRelay)
        {
            ...
            try
            {
                ContractParametersContext context = ContractParametersContext.Parse(jsonObjectToRelay.ToString(), Snapshot);
