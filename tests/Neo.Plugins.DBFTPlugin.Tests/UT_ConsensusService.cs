...
public class UT_ConsensusService : TestKit
{
    ...
    public void TestConsensusServiceRoutesConsensusMessagesIntoContextState()
    {
        ...
        Assert.IsNotNull(context.TransactionHashes);
    ...
    public void TestConsensusServiceExecutesSendAndCheckPaths()
    {
        ...
        InvokeConsensusMethod(primaryActor, "RequestChangeView", ChangeViewReason.Timeout);
        ...
        Assert.IsTrue(InvokeConsensusMethod(backupActor, "CheckPrepareResponse") as bool?);
